...
{
    static OdometryHandler *s_instance; //static instance of class
    
    //values to hold odometry callbacks
    ...
    public:
        ...
        void handleOdom(const nav_msgs::Odometry::ConstPtr& message);

        double getOdometry(){return message.;}
